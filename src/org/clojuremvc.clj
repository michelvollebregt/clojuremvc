             ...
             `(.put ~this ~url
                 (proxy [AbstractController] []
                   (handleRequestInternal [request# response#]
                     ;(let [[a b] [1 2]]
                     (with-controller-params request# ~params ; binds the request parameters and session attributes
...
;;; vraag: kunnen we ALLE namespaces doorzoeken? (hoe gaat dit in test-is?)
